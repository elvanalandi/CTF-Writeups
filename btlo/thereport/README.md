...
**Question 2**  
>**Mention the MITRE Technique ID which effected more than 50% of the customers**  
...
**Question 4**  
>**Submit the CVE of the zero day vulnerability of a driver which led to RCE and gain SYSTEM privileges**  
...
**Question 5**  
>**Mention the 2 adversary groups that leverage SEO to gain initial access**  
...
**Question 6**  
>**In the detection rule, what should be mentioned as parent process if we are looking for execution of malicious js files [Hint: Not CMD]**  
...
**Question 7**  
>**Ransomware gangs started using affiliate model to gain initial access. Name the precursors used by affiliates of Conti ransomware group**  
...
**Question 8**  
>**The main target of coin miners was outdated software. Mention the 2 outdated software mentioned in the report**  
...
**Question 9**  
>**Name the ransomware group which threatened to conduct DDoS if they didn’t pay ransom**  
...
**Question 10**  
>**What is the security measure we need to enable for RDP connections in order to safeguard from ransomware attacks?**  
